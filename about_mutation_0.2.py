...
for i in sample:
    ...
    for j in range(20):
        ...
        DB_regular = Evolution.Evolution(population, nx.adjacency_matrix(struc).indices.reshape(400,3), 0.2, np.array([3,-1,4,0,i,0.8]), 0.01)
        DB_regular.DB_evolve(DB_regular,200000)
        with open('0.2'+str(i)+'.txt', 'ab') as f:
