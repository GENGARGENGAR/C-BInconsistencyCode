...
class Evolution_5_opinions:
    def __init__(self, population: np.ndarray, struc: np.ndarray, mutation: float, payoffs: np.ndarray, intensity: float):
        ...
        self.evolution_state = np.array([np.count_nonzero(self.population==0), np.count_nonzero(self.population==1), np.count_nonzero(self.population==2), np.count_nonzero(self.population==3), np.count_nonzero(self.population==4), np.count_nonzero(self.population==5), np.count_nonzero(self.population==6), np.count_nonzero(self.population==7), np.count_nonzero(self.population==8), np.count_nonzero(self.population==9)]).reshape(1,10)/self.pop_size
